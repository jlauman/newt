...
var _user$project$Main$decoder = _elm_lang$core$Json_Decode$keyValuePairs(_elm_lang$core$Json_Decode$string);
var _user$project$Main$echoServer = 'ws://127.0.0.1:8080/ws';
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {clientMessage: a, serverMessage: b, serverTime: c};
	});
var _user$project$Main$init = {
	ctor: '_Tuple2',
	_0: A3(_user$project$Main$Model, '', '', 'Waiting...'),
	_1: _elm_lang$core$Platform_Cmd$none
};
var _user$project$Main$update = F2(
	function (msg, _p0) {
		var _p1 = _p0;
		var _p6 = _p1.serverTime;
		var _p5 = _p1.serverMessage;
		var _p4 = _p1.clientMessage;
		var _p2 = msg;
		switch (_p2.ctor) {
			case 'Input':
				return {
					ctor: '_Tuple2',
					_0: A3(_user$project$Main$Model, _p2._0, _p5, _p6),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Send':
				var message = A2(
					...
					_elm_lang$core$Json_Encode$object(
						_elm_lang$core$Native_List.fromArray(
							[
								...
								ctor: '_Tuple2',
								_0: 'message',
								_1: _elm_lang$core$Json_Encode$string(_p4)
							}
							])));
				return {
					ctor: '_Tuple2',
					_0: A3(_user$project$Main$Model, '', _p5, _p6),
					_1: A2(_elm_lang$websocket$WebSocket$send, _user$project$Main$echoServer, message)
				};
			default:
				var result = A2(
					_elm_lang$core$Debug$log,
					'result',
					A2(_elm_lang$core$Json_Decode$decodeString, _user$project$Main$decoder, _p2._0));
				var _p3 = result;
				_v2_2:
				do {
					if (_p3.ctor === 'Ok') {
						if (((_p3._0.ctor === '::') && (_p3._0._0.ctor === '_Tuple2')) && (_p3._0._1.ctor === '[]')) {
							switch (_p3._0._0._0) {
								case 'time':
									return {
										ctor: '_Tuple2',
										_0: A3(_user$project$Main$Model, _p4, _p5, _p3._0._0._1),
										_1: _elm_lang$core$Platform_Cmd$none
									};
								case 'ok':
									return {
										ctor: '_Tuple2',
										_0: A3(_user$project$Main$Model, _p4, _p3._0._0._1, _p6),
										_1: _elm_lang$core$Platform_Cmd$none
									};
								default:
									break _v2_2;
						...
						return {
							ctor: '_Tuple2',
							_0: A3(_user$project$Main$Model, _p4, _p3._0, _p6),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					}
				} while(false);
				return {
					ctor: '_Tuple2',
					_0: A3(_user$project$Main$Model, _p4, _p5, _p6),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Server Time: '),
								_elm_lang$html$Html$text(model.serverTime)
							]))
					])),
				A2(
				_elm_lang$html$Html$section,
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Client Message: '),
								A2(
								_elm_lang$html$Html$input,
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Events$onInput(_user$project$Main$Input),
										_elm_lang$html$Html_Attributes$value(model.clientMessage)
									]),
								_elm_lang$core$Native_List.fromArray(
									[])),
								A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Server Message: '),
								_elm_lang$html$Html$text(model.serverMessage)
							]))
					]))
			]));
};
